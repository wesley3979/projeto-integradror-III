...
routes.post('/championship/insert', checkToken, teamController.insertTeamIntoChampionship)
routes.delete('/delete/:id', checkToken, teamController.deleteTeam)
routes.get('/creatorUserId/:id', checkToken, teamController.getTeamsByCreatorUserId)
